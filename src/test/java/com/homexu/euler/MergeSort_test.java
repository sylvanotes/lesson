...
public class MergeSort_test {
	...
	public void test_startInMiddle()
	{
		...
		MergeSort.sortArray(toSort, 4, 14);
		String x = MergeSort.display(toSort);
	...
	{
		int[] toSort = {4, 3,};
		MergeSort.sortArray(toSort, 0, 2);
		String x = MergeSort.display(toSort);
		assertThat(x, equalTo("(3, 4)"));
	}
	
	@Test
	public void test_sort2ndAnd3rd()
	{
		int[] toSort = {1, 2, 3, 4, 3,};
		MergeSort.sortArray(toSort, 3, toSort.length);
		String x = MergeSort.display(toSort);
		assertThat(x, equalTo("(1, 2, 3, 3, 4)"));
	}
